...
- 🏢 **7+ years** working with Epicor ERP as a technical consultant
- 💻 Full-stack: Python, TypeScript, C# — from enterprise backends to modern SPAs
- 🧩 Translating functional requirements into real solutions
...
**Stack:** Python · FastAPI · React · TypeScript · SAP RFC · Peruri SDK · MinIO
